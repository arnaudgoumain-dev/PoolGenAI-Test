...
const FIREBASE_PROJECT_ID = "poolgenai-test"; // ⚠️ À VÉRIFIER contre le Quick Edit actuel
...
const VERIFICATION_LINK_BASE = "https://test.poolgenai.com/"; // ⚠️ À VÉRIFIER contre le Quick Edit actuel
